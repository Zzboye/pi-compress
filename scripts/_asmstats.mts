...
import { countTokens, splitIntoTurns, type MessageEntry } from "../src/util.js";
...
const tok = (m: any) => countTokens(m, { skipThinking: true });
...
const native = branch.reduce((s: number, e) => s + countTokens(e.message as any), 0);
